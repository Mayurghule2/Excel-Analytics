...
const UploadHistory = () => {
  ...
  return (
    <div className="p-8 min-h-screen bg-gradient-to-tr from-white to-blue-50  text-gray-800 transition">
      <h2 className="text-3xl font-bold mb-6 flex items-center gap-2">Upload History</h2>

      <div className="grid grid-cols-1 md:grid-cols-5 gap-4 mb-6">
  <div className="flex items-center gap-2 border rounded-lg px-3 py-2 bg-white  border-gray-300 ">
  ...
  >
    ...
    Reset
      ...
      {loading ? (
        ...
        <p className="text-gray-500 ">No matching uploads found.</p>
      ) : (
        <div className="grid gap-6 md:grid-cols-2 xl:grid-cols-3">
          {filteredUploads.map((upload) => {
            ...
            return (
              <div
                key={upload._id}
                className="bg-white  rounded-xl shadow-md hover:shadow-lg transition transform hover:-translate-y-1 border border-gray-200 "
              >
