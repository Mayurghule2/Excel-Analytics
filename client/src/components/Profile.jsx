...
const Profile = () => {
  ...
  return (
    <div className="min-h-screen flex items-center justify-center bg-gray-100 p-6 ">
      <div className="flex flex-col md:flex-row items-center gap-10 p-8 bg-white  rounded shadow-md w-full max-w-4xl">
        ...
        <div className="w-full md:w-1/2">
          ...
          <div className="mb-4">
            <label className="block mb-1 text-sm font-semibold text-gray-700 ">Profile Image</label>
            <input
              type="file"
              accept="image/*"
