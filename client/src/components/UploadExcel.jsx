...
const handleAnalyze = async () => {
  ...
  return (
    <div className={"flex flex-col min-h-screen bg-gradient-to-r from-[#aeffff] to-cyan text-gray-900"}>
 

      <div className="my-20 w-full flex flex-col justify-around  gap-10 px-10 items-center">
  
        <div className="w-full md:w-2/3  text-center p-10 border-2 border-dashed border-blue-400 bg-white/60 rounded-md md:pt-16 md:pb-16 shadow-md flex flex-col items-center gap-4">
          ...
          <p className="text-sm mb-4 text-gray-500 ">Upload your Excel file (.xls or .xlsx) to analyze and visualize your data</p>
        ...
        <div className="w-full bg-white/60 p-6 rounded-lg shadow overflow-auto max-h-[400px]">
          <h3 className="text-lg font-semibold mb-4">Preview</h3>
          {excelData.length > 0 ? (
            <table className="min-w-full text-sm">
              <thead>
                <tr className=" bg-blue-700  text-gray-100 ">
