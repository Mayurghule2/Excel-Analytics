...
const GenerateInsights = ({ headers, rows }) => {
  ...
  return (
    <div className="mt-10 p-6 bg-white  shadow-lg rounded-2xl max-w-5xl mx-auto transition-all duration-300">
      ...
      {error && (
        <p className="text-red-600 mt-4 font-medium bg-red-100 p-3 rounded-lg">
          {error}
        </p>
      )}

      {insights && (
        <div className="mt-6 bg-gray-100  p-6 rounded-xl border border-gray-300 ">
